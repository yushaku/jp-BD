...
export function Hero({ data }: { data: HeroData }) {
  return (
    <section className="relative mb-12 bg-gradient-to-br from-jp-paper via-jp-cream to-white px-6 py-16 text-center">
      ...
      <div className="relative">
        ...
        <div className="mt-5">
          <Badge
            variant="outline"
            className="border-jp-gold text-jp-gold uppercase tracking-wider"
          >
            Chính hãng · Nhập khẩu Nhật Bản
          </Badge>
        </div>
      </div>
    </section>
